    ...
    <body>
        ...
        <div class="art">
            <div id="contact">
                ...
                <div class="con">
                   <img src="1x/boss2.png" alt=""> <br>
                    Prezes giełdy: Mateusz Żak
                </div>
                <div class="con">
                   <img src="1x/company.png" alt="Company"> <br>
                    Siedziba firmy - ul. Chmurkowa 21/37, Kraków
                </div>
                <div class="con">
                   <img src="1x/telephone.png" alt=""> <br>
                    Nr telefonu: +48 679 543 134
                </div>
            </div>
        </div>
        <footer>
