<nav class="navbar navbar-expand-lg container-fluid" style="background-color: #12161c">
            ...
            <?php if(isset($_SESSION['zalogowany'])): ?>
                    ...
                    <div class="buttons">
                        <a class="nav-link" href="profile.php" style="margin-right: 10px;disabled;">Profil</a>
                        <a
                            class="nav-link"
                            id="rejestr"
                            href="logout.php"
                ...
                <div class="collapse navbar-collapse" id="menu">
                    <ul class="navbar-nav">
                        ...
                        <div class="papi">
                            <li>
                                <a class="nav-link" href="loginx.php" style="margin-right: 10px"
                                    >Zaloguj się</a
                                >
                            </li>
                            <li>
                                <a class="nav-link register"
                                    href="register.php"
                                    style="border-radius: 10px">Rejestracja</a>
                            </li>
                        </div>
                    </ul>
                </div>
